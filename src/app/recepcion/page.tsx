...
import {
    ...
    FileText, Phone, Mail, Stethoscope, User, Search, DollarSign
} from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center bg-white p-4 rounded-2xl shadow-sm border border-gray-100 gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Gestiona citas y llegadas de pacientes.</p>
                </div>
                ...
                <div className="flex items-center gap-4 bg-gray-50 p-2 rounded-xl border border-gray-200">
                    ...
                    <div className="text-center min-w-[140px]">
                        <span className="block font-bold text-gray-800 capitalize text-lg">
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-lime-500/50"
                    />
                </div>
                <select
                    value={statusFilter}
                    onChange={(e) => setStatusFilter(e.target.value)}
                    className="px-4 py-2 rounded-xl border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-lime-500/50 text-gray-700 min-w-[200px]"
                >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-4 border-b border-gray-100 bg-gray-50/50">
                    <h3 className="font-bold text-gray-700 text-sm uppercase tracking-wide">Desglose de Citas</h3>
                </div>
                                ...
                                filteredAppointments.map((apt) => (
                                    <tr key={apt.id} className="hover:bg-gray-50/80 transition-colors group">
                                        ...
                                        <td className="p-4 align-top">
                                            <div className="font-bold text-gray-800 text-lg leading-none whitespace-nowrap">
                                                {apt.startTime}
                                            </div>
                                        </td>
